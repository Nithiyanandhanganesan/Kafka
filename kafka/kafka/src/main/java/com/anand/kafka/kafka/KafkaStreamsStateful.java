...
public class KafkaStreamsStateful {
    ...
    public static void main(String[] args) {
        ...
        aggregatedTable.toStream().to("branch1", Produced.with(Serdes.String(), Serdes.Integer()));
        //./bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic branch1 --from-beginning --property print.key=true --property value.deserializer=org.apache.kafka.common.serialization.IntegerDeserializer
        ...
        countedTable.toStream().to("branch2", Produced.with(Serdes.String(), Serdes.Long()));
        //./bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic branch1 --from-beginning --property print.key=true --property value.deserializer=org.apache.kafka.common.serialization.LongDeserializer
        ...
        reducedTable.toStream().to("branch3");
