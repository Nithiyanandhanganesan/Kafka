...
public class KafkaJoins {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, String> left = builder.stream("streams-input-topic");
        KStream<String, String> right = builder.stream("streams-input-topic1");
